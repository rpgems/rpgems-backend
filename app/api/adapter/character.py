...
from app.services.character import (
    service_get_character_by_id,
    service_list_characters,
    service_search_characters_by_name,
    service_create_character,
...
def adapt_get_character_by_id(character_id) -> CharacterResponse:
    ...
    character_result = CharacterResponse(
        id=char_response.id,
...
def adapt_search_characters_by_name(name_search: str) -> List[CharacterResponse]:
    ...
    :return:
    """
    character_list_response: List[Character] = service_search_characters_by_name(
        name_search
    )
    character_list_result: List[CharacterResponse] = []
    for char_resp in character_list_response:
...
def adapt_update_character_definition(
