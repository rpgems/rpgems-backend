...
from app.services.character_attribute import (
    service_get_attribute_by_id,
    service_list_attributes,
...
def adapt_get_attribute_by_id(attribute_id: int) -> CharacterAttributeResponse:
    ...
    attribute_result = CharacterAttributeResponse(
...
def adapt_update_attribute_definition(
